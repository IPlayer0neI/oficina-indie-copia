...
interface ShowcaseProps {
    ...
    height: number;
    refMeasuresInstance: RefObject<HTMLDivElement> | ({ clientWidth: number, clientHeight: number });
            ...
            <div style={{ height: height }} className={styles.carousel}>
                {
                    items.map(function (value, index) {
                        ...
                        return (
                            <div
                                ref={index == 0 ? refMeasuresInstance as RefObject<HTMLDivElement> : undefined}
                            ...
                            >
                                ...
                                <img className={styles.itemImg} src={`assets/${imgBasePath}/${imgName}`} alt={imgName} />
                                {
                                    isArray && (
